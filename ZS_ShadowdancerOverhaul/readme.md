...
- **Shadow Leap**: A much weaker Shadowstep-like teleport that grants minor benefits for 1 round, does not break invisibility, and can be used once per turn. Unlike normal Shadowstep, it can be interrupted by damage and uses your action per round.
...
- **Shadow Evade**: You get one use at level 4. It is essentially a much weaker Shadow Form: +4 AC, +2 Saving Throws, +15% damage reduction, and invisibility for 5 rounds. Further uses are gained at levels 9 and 13, and damage resistance increases by 5% each time. It also grants immunity to Shadow Fireball and Delayed Blast Shadow Fireball.
...
- **Fell Strike**: This ability lets the shadowdancer imbue their attacks with energy from the Shadow Deep. For 1 round after activation, attacks also deal maximum damage. For 1 turn, backstabs gain one of three chosen effects. During this time, critical hit chances increase by 5%, and against backstab-immune targets, all successful hits have a 10% chance to strip that immunity for 10 seconds, once every 5 rounds per target. These effects ignore Magic Resistance.
...
- **Self-concealment**: 4% universal damage resistance and +1 AC. Can be taken three times. Inspired by NWN. Damage resistance is configurable in the preferences file.
...
I would suggest installing my tweaks in ZSTweaks for Assassination to make the remaining thief HLA even more rewarding, along with my other thematic rogue tweaks, including THAC0 improvements for rogues. For BG, I also highly recommend installing something that enables the Evasion ability from IWD, to make thieves more powerful than they are, as they should be. And something that allows them to take 3 pips in dual wielding, for crying out loud.

...
- Shadow Jump is a Time Stop effect, so it would be possible to cast it over and over to make some effect on the enemy wear off with no consequences. So again, it's a matter of your tolerance for cheesiness. I'm considering to make the ability a toggle, where you can select either the usual effect or an instant teleport type effect, if that suits your needs better.

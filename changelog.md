...
- Fixed bug that made the Darkness spell affect undead and demons, which is unintended
...
- Shadow Artisan HLA renamed to Shadow Weaver
...
- Updated the compatibility code if my tweak pack is detected
